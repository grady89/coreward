...
export const VAULTS: VaultDef[] = [
  ...
  // you are in and never the hall behind it.
  {
    ...
    shuttles: [
      ...
      { x0: 37, y0: 24, x1: 37, y1: 29, period: 2.55, phase: 0.0 },
      { x0: 23, y0: 24, x1: 23, y1: 29, period: 1.70, phase: 0.25 },
      { x0: 9, y0: 24, x1: 9, y1: 29, period: 2.55, phase: 0.75 },
    ...
    currents: [
      ...
      { x0: 3, y0: 18, x1: 6, y1: 23, force: 46 },
    ],
    map: [
      '########################################################',
      '########################################################',
