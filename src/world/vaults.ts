...
export const VAULTS: VaultDef[] = [
  ...
  // you are in and never the hall behind it.
  {
    ...
    shuttles: [
      { x0: 24, y0: 36, x1: 24, y1: 41, period: 3.40, phase: 0.0 },
      { x0: 40, y0: 36, x1: 40, y1: 41, period: 2.55, phase: 0.25 },
      { x0: 47, y0: 36, x1: 47, y1: 41, period: 2.55, phase: 0.5 },
    ...
    currents: [
      ...
      { x0: 49, y0: 30, x1: 52, y1: 35, force: 46 },
