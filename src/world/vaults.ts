...
export const VAULTS: VaultDef[] = [
  ...
  // you are in and never the hall behind it.
  {
    ...
    shuttles: [
      { x0: 20, y0: 41, x1: 33, y1: 41, period: 2.55, phase: 0.0 },
      { x0: 24, y0: 36, x1: 24, y1: 41, period: 1.70, phase: 0.25 },
      { x0: 30, y0: 36, x1: 30, y1: 41, period: 1.70, phase: 0.75 },
      { x0: 41, y0: 24, x1: 41, y1: 29, period: 2.55, phase: 0.0 },
      { x0: 33, y0: 24, x1: 33, y1: 29, period: 2.55, phase: 0.5 },
      { x0: 24, y0: 24, x1: 24, y1: 29, period: 1.70, phase: 0.25 },
      { x0: 26, y0: 24, x1: 26, y1: 29, period: 1.70, phase: 0.75 },
      { x0: 19, y0: 12, x1: 19, y1: 17, period: 1.70, phase: 0.0 },
      { x0: 36, y0: 12, x1: 36, y1: 17, period: 1.70, phase: 0.5 },
      { x0: 45, y0: 12, x1: 45, y1: 17, period: 1.70, phase: 0.25 }
    ],
    currents: [
      ...
      { x0: 50, y0: 30, x1: 53, y1: 35, force: 46 },
      { x0: 19, y0: 18, x1: 22, y1: 23, force: 46 },
    ],
    map: [
      '########################################################',
      '########################################################',
