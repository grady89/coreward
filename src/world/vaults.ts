...
export const VAULTS: VaultDef[] = [
  ...
  // to one spark and a landing. The first shuttle bolts patrol the runs.
  {
    ...
    shuttles: [
      ...
      { x0: 20, y0: 12, x1: 20, y1: 14, period: 1.8, phase: 0.3 },
      { x0: 16, y0: 4, x1: 32, y1: 4, period: 3.4, phase: 0.6 },
    ],
    map: [
      '##################################################',
      '##################################################',
  ...
  // way down is rimmed with unlight; the last hall swings a censer.
  {
    ...
    beams: [
      ...
      { x: 24.5, y: 22.2, period: 2.7, phase: 0.7, spin: true },
    ],
    censers: [
      { x: 21, y: 28, len: 4.2, arc: 1.05, period: 2.7, phase: 0 },
    ],
    map: [
      '####################################################',
      '####################################################',
  ...
  // out or not at all.
  {
    ...
    shuttles: [
      { x0: 13, y0: 22, x1: 19, y1: 22, period: 2.6, phase: 0 },
      { x0: 23, y0: 22, x1: 31, y1: 22, period: 2.9, phase: 0.5 },
      { x0: 46, y0: 21, x1: 56, y1: 21, period: 2.2, phase: 0.4 },
    ],
    map: [
      '############################################################',
      '############################################################',
  ...
  // pistons still cycle on both sides — mirrored, out of phase.
  {
    ...
    crushers: [
      ...
      { x: 1, y: 7, w: 2, h: 2, dx: 3, dy: 0, period: 3.2, phase: 0 },
      { x: 19, y: 11, w: 2, h: 2, dx: -4, dy: 0, period: 3.2, phase: 0.5 },
      // right cell, upside down: they drop from what you fall toward
      { x: 30, y: 1, w: 2, h: 2, dx: 0, dy: 4, period: 3.4, phase: 0.7 },
      { x: 38, y: 1, w: 2, h: 2, dx: 0, dy: 5, period: 2.8, phase: 0.25 },
    ],
    map: [
      '######################################################',
      '######################################################',
  ...
  // who stayed and lit the sconce beside it.
  {
    ...
    censers: [
      ...
      { x: 6, y: 19, len: 3.2, arc: 1.0, period: 2.2, phase: 0.5 },
    ],
    shuttles: [
      { x0: 26, y0: 29, x1: 26, y1: 32, period: 1.7, phase: 0 },
      { x0: 38, y0: 29, x1: 38, y1: 32, period: 1.9, phase: 0.5 },
    ],
    crushers: [
      { x: 44, y: 18, w: 2, h: 2, dx: -3, dy: 0, period: 2.9, phase: 0 },
    ],
    map: [
      '########################################################',
      '########################################################',
  ...
  // dark itself follows you to the four who stayed.
  {
    ...
    shuttles: [
      { x0: 10, y0: 38, x1: 22, y1: 38, period: 2.5, phase: 0 },
      { x0: 34, y0: 39, x1: 48, y1: 39, period: 2.1, phase: 0.5 },
    ],
    censers: [
      { x: 16, y: 24, len: 3.2, arc: 1.0, period: 2.5, phase: 0 },
      { x: 28, y: 24, len: 3.2, arc: 1.0, period: 2.5, phase: 0.33 },
      { x: 40, y: 24, len: 3.2, arc: 1.0, period: 2.5, phase: 0.66 },
    ],
    crushers: [
      { x: 2, y: 19, w: 2, h: 2, dx: 3, dy: 0, period: 2.6, phase: 0 },
      { x: 7, y: 14, w: 2, h: 2, dx: -3, dy: 0, period: 2.6, phase: 0.5 },
    ],
    map: [
      '##########################################################',
      '##########################################################',
